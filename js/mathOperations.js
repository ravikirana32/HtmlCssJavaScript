...
console.log(Math.abs(-15.35));//15.35
...
//Match.max(2,3,4,10,5,20.....)
console.log("\n---------------------  max()  --------------");
console.log(Math.max(2,3,4,10,5,20));//20


//The min() method returns the number with the lowest value.
//Match.min(2,3,4,10,5,20.....)
console.log("\n---------------------  min()  --------------");
console.log(Math.min(2,3,4,10,5,20));//2
...
//Math.pow(x, y)
//Return the value of the number 4 to the power of 3 (4*4*4): Math.pow(4, 3)
console.log("\n---------------------  pow()  --------------");
